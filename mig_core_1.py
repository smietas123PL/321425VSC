...
import pathlib
pathlib.Path(r'c:\Users\User\Downloads\AgentSpark\321425VSC\js\core\sync-queue.ts').write_text(sync_queue_ts, encoding='utf-8')

if os.path.exists(r'c:\Users\User\Downloads\AgentSpark\321425VSC\js\core\sync-queue.js'):
    os.remove(r'c:\Users\User\Downloads\AgentSpark\321425VSC\js\core\sync-queue.js')

print("Migrated sync-queue")
