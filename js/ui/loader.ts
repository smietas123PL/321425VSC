...
export function showGlobalLoader(message = 'Processing...', overlay = true) {
    let loader = (document.getElementById('global-spinner-modal') as HTMLElement);
    if (!loader) {
    ...
    const msgEl = (document.getElementById('global-loader-message') as HTMLElement);
...
export function hideGlobalLoader() {
    const loader = (document.getElementById('global-spinner-modal') as HTMLElement);
    if (loader) {
